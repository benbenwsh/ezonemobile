...
export default function Item(props) {
  ...
  return (
    <div className="card h-100">
      <img src={"data:image/jpg;base64," + binaryImg} className="card-img-top" alt={props.item.name} />
      <div className="card-body d-flex flex-column">
        <h2 className="card-title">Apple {props.item.version} - {props.item.model}</h2>
